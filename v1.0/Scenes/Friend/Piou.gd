...
func _ready():
	...
	var scale_factor = get_node("/root/Autoloader").piou_scale_percent
...
func calculate_movement():
	...
	movement_speed = rand_range(Autoloader.piou_speed_min, Autoloader.piou_speed_max)
...
func _on_Area2D_body_entered(body):
	...
	if body.is_in_group("ball"):
		# Décrémenter le score en fonction de la valeur définie dans Autoloader et supprimer l'objet
		var autoloader = get_node("/root/Autoloader")
		autoloader.update_score(-autoloader.piou_pts_value)
		queue_free()
